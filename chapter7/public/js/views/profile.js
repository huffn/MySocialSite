define(['SocialNetView', 'text!templates/profile.html', 'text!templates/status.html', 'models/status', 'views/status'], function(SocialNetView, profileTemplate, statusTemplate, Status, StatusView){
